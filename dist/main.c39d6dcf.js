...
exports.foo = function () {
  return console.log("dynamic import: module.foo() scope");
};
...
var worker = new Worker("/worker.cf9e192a.js");
...
setTimeout(function () {
  Promise.resolve().then(function () {
    return __importStar(require("./dynamic"));
  }).then(function (dynamic) {
    return dynamic.foo();
  });
}, 1000);
},{"d3":"../node_modules/d3/index.js","./worker.ts":[["worker.cf9e192a.js","worker.ts"],"worker.cf9e192a.js.map","worker.ts"],"./dynamic":"dynamic.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
